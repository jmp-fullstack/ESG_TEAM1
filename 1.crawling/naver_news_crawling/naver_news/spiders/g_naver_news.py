...
with open('./keywords/G_key_words.txt', encoding='utf-8') as keyword_f:
    g_list = [lines.rstrip() for lines in keyword_f.readlines()]
...
class g_naver_news(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if clean_sent == []:
            ...
            values = (company, date, title, sentence, url,'g')
